...
class GUI:
    def __init__(self, winroot):
        ...
        self.fr_data_camara = tk.Frame(self.winroot, width=600, height=300, borderwidth=2, relief='groove')
        self.fr_data_camara.place(x=10, y=10)
        self.ip_label = tk.Label(self.winroot, text='Ingrese la dirección de la cámaras:')
        ...
        self.lb_stat_camara.place(x=15,y=215)
